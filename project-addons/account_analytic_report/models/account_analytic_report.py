...
class AccountAnalyticReport(models.Model):
    ...
    cost_feed_milk_cow_day_1 = fields.Float('Coste de Alimentación vaca lactación/día (€)', default=1)
    cost_feed_dry_cow_day_1 = fields.Float('Coste de Alimentación vaca seca/día (€)', default=1)
    corn_hectares_1 = fields.Float('Corn hectares', default=1)
    kg_corn_1 = fields.Float('Corn Kg', default=1)
    grass_hectares_1 = fields.Float('Grass hectares', default=1)
    kg_grass_1 = fields.Float('Grass Kg', default=1)
    cereal_hectares_1 = fields.Float('Cereal hectares', default=1)
    kg_cereal_1 = fields.Float('Cereal Kg', default=1)
    dry_grass_hectares_1 = fields.Float('Dry grass hectares', default=1)
    kg_dry_grass_1 = fields.Float('Dry grass Kg', default=1)
    another_hectares_1 = fields.Float('Another hectares', default=1)
    kg_another_1 = fields.Float('Another Kg', default=1)
    cow_buy_1 = fields.Float('Livestock purchased', default=1)
    inventory_difference_1 = fields.Float('Inventory difference', default=1)
    ...
    cost_feed_milk_cow_day_2 = fields.Float('Coste de Alimentación vaca lactación/día (€)', default=1)
    cost_feed_dry_cow_day_2 = fields.Float('Coste de Alimentación vaca seca/día (€)', default=1)
    corn_hectares_2 = fields.Float('Corn hectares', default=1)
    kg_corn_2 = fields.Float('Corn Kg', default=1)
    grass_hectares_2 = fields.Float('Grass hectares', default=1)
    kg_grass_2 = fields.Float('Grass Kg', default=1)
    cereal_hectares_2 = fields.Float('Cereal hectares', default=1)
    kg_cereal_2 = fields.Float('Cereal Kg', default=1)
    dry_grass_hectares_2 = fields.Float('Dry grass hectares', default=1)
    kg_dry_grass_2 = fields.Float('Dry grass Kg', default=1)
    another_hectares_2 = fields.Float('Another hectares', default=1)
    kg_another_2 = fields.Float('Another Kg', default=1)
    cow_buy_2 = fields.Float('Livestock purchased', default=1)
    inventory_difference_2 = fields.Float('Inventory difference', default=1)
...
class AccountAnalyticReportLine(models.Model):
    ...
    value_1_1 = fields.Float('Value 1.1')
    value_1_2 = fields.Float('Value 1.2')
    value_2_1 = fields.Float('Value 2.1')
    value_2_2 = fields.Float('Value 2.2')
