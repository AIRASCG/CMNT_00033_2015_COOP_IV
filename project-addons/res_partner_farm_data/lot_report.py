    ...
    def render_html(self, data=None):
        ...
        for o in objs:
            ...
            tab_struct = [
                ...
                ('o', 'Producción por cubículo:', '0', '0'),
                ('p', 'Producción corregida por cubículo:', '0', '0'),
                ...
                ('aa', 'Diferencia :', 'lot.diff_ing_cost', 'table["z"]["total"] - table["x"]["total"]'),
                ('ab', '% alimentación sobre ingresos leche:', 'lot.perc_feed_milk_ingress', 'table["x"]["total"] / table["z"]["total"]'),
